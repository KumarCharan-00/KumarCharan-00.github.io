          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr', gap: 36 }} className="pitch-grid">
            ...
            <div>
              ...
              <p style={{ fontSize: '0.92rem', color: '#475569', lineHeight: 1.7, marginBottom: 22, maxWidth: 620 }}>
                From high-throughput Java microservices to Python LLM agents and AWS serverless infra, I bring full-cycle engineering discipline: clean architecture, security-first design, and cost-optimised cloud delivery.
              </p>
            ...
            <div className="glass-card" style={{
              ...
              <p style={{ fontSize: '0.78rem', color: '#64748b', marginBottom: 24, lineHeight: 1.65 }}>
                Java, Python, and AWS architecture consultation, code review, or hands-on delivery: let's connect.
              </p>
