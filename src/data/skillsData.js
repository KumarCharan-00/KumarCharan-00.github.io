...
export const skillsCategories = [
  {
    ...
    skills: [
      ...
      { name: 'Spring MVC / WebFlux',       exp: '3+ Yrs',  tag: 'REST APIs' },
      { name: 'Spring Data JPA / Hibernate',exp: '3+ Yrs',  tag: 'ORM' },
      { name: 'Microservices Architecture', exp: '4+ Yrs',  tag: 'System Design' },
      { name: 'Event-Driven (Kafka / SQS)', exp: '2+ Yrs',  tag: 'Async' },
      { name: 'gRPC / REST / GraphQL',      exp: '2+ Yrs',  tag: 'API Design' },
  ...
  },
  {
    ...
    color: '#F9BE00',
    skills: [
      { name: 'AWS Lambda',                 exp: '3+ Yrs',  tag: 'Serverless' },
      { name: 'API Gateway (HTTP v2)',       exp: '3+ Yrs',  tag: 'REST / WebSocket' },
      { name: 'Amazon ECS / Fargate',       exp: '2+ Yrs',  tag: 'Containers' },
      { name: 'DynamoDB',                   exp: '3+ Yrs',  tag: 'NoSQL' },
      { name: 'SQS / SNS',                  exp: '3+ Yrs',  tag: 'Messaging' },
      { name: 'SAM / CloudFormation',       exp: '2+ Yrs',  tag: 'IaC' },
      { name: 'S3 / CloudFront',            exp: '3+ Yrs',  tag: 'Storage & CDN' },
      { name: 'CloudWatch / X-Ray',         exp: '2+ Yrs',  tag: 'Observability' },
    ],
  },
  {
